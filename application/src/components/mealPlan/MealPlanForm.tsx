...
export function MealPlanForm({ initialData, recipes, onSubmit, isSubmitting, serverErrors }: MealPlanFormProps) {
   ...
   const validate = () => {
      ...
      if (meals.length === 0) {
         ...
         meals.forEach((meal, index) => {
            if (!meal.recipe) {
               newErrors[`meals.${index}.recipe`] = "Wybierz przepis";
            }
            if (!meal.date) {
               newErrors[`meals.${index}.date`] = "Wybierz datę";
            } else if (meal.date < startDate || meal.date > endDate) {
               newErrors[`meals.${index}.date`] = "Data musi być w zakresie planu";
            }
            if (!meal.mealType) {
               newErrors[`meals.${index}.mealType`] = "Wybierz rodzaj posiłku";
            }
            if (!meal.servings || meal.servings < 1) {
               newErrors[`meals.${index}.servings`] = "Podaj prawidłową liczbę porcji";
            }
         });
      }
   ...
   const updateMeal = (index: number, field: keyof MealItemFormData, value: string | number | Date) => {
                     ...
                     <div className="space-y-2">
                        ...
                        <Popover>
                           <PopoverTrigger asChild>
                              ...
                              >
                                 {startDate ? format(startDate, "dd.MM.yyyy", { locale: pl }) : "Wybierz datę"}
                              </Button>
                           </PopoverTrigger>
                     ...
                     <div className="space-y-2">
                        ...
                        <Popover>
                           <PopoverTrigger asChild>
                              ...
                              >
                                 {endDate ? format(endDate, "dd.MM.yyyy", { locale: pl }) : "Wybierz datę"}
                              </Button>
                           </PopoverTrigger>
                           <PopoverContent className="w-auto p-0" align="start">
                              <Calendar
                              ...
                              <CardContent className="p-4 space-y-4">
                                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                       ...
                                       >
                                          <SelectTrigger
                                             className={errors[`meals.${index}.recipe`] ? "border-destructive" : ""}
                                          >
                                    ...
                                    <div className="space-y-2">
                                       ...
                                       >
                                          <SelectTrigger
                                             className={errors[`meals.${index}.mealType`] ? "border-destructive" : ""}
                                          >
                                             <SelectValue />
                                          </SelectTrigger>
                                          <SelectContent>
                                 ...
                                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                       ...
                                       <Popover>
                                          <PopoverTrigger asChild>
                                             <Button
                                                ...
                                                className={cn(
                                                   "w-full justify-start text-left font-normal",
                                                   errors[`meals.${index}.date`] || !isDateInRange(meal.date)
                                                      ? "border-destructive"
                                                      : "",
                                             ...
                                             >
                                                {meal.date
                                                   ? format(meal.date, "dd.MM.yyyy", { locale: pl })
                                                   : "Wybierz datę"}
                                             </Button>
                                          </PopoverTrigger>
                                    ...
                                    <div className="space-y-2">
                                       ...
                                       <Input
                                          ...
                                          className={errors[`meals.${index}.servings`] ? "border-destructive" : ""}
                                       />
