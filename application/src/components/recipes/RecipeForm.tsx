...
import { useUnitsWithTranslations } from "@/utils/units/Units";
...
export const RecipeForm = ({
  ...
  const defaultValues = {
    ...
    instructions: initialData?.instructions?.map((instruction) => ({
      value: instruction,
    })) || [{ value: "" }],
      ...
      <form onSubmit={form.handleSubmit(onFormSubmit)} className="space-y-8">
        ...
        <div className="space-y-4">
            ...
            <div key={field.id} className="flex items-end gap-2">
              ...
              <div className="w-32">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t("ingredients.unit.label")} *</FormLabel>
                      <Select
                      ...
                      >
                        <FormControl>
                          <SelectTrigger className="w-full">
                            <SelectValue
                              placeholder={t("ingredients.unit.label")}
                            />
                          </SelectTrigger>
                        </FormControl>
                        <SelectContent>
          ...
          <Button
            ...
            variant="outline"
            onClick={() =>
              appendIngredient({ name: "", quantity: 1, unit: "piece" })
            }
            disabled={isLoading}
          >
                  ...
                  <li key={field.id} className="flex items-center gap-2">
                    ...
                    <div className="flex gap-1">
                      <Button
                        ...
                        onClick={() =>
                          index > 0 && swapInstructions(index, index - 1)
                        }
                      ...
                      <Button
                        ...
                        onClick={() =>
                          ...
                          swapInstructions(index, index + 1)
                        }
                        disabled={
                          isLoading || index === instructionFields.length - 1
                        }
                      >
                        ↓
                      </Button>
