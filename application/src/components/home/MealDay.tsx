...
import { findMealIndex, getRecipeDetails, sortMealsByType } from "@/utils/mealUtils";
...
interface MealDayProps {
   ...
   onMealStatusChange: (mealPlanId: string, mealIndex: number, isCompleted: boolean) => Promise<void>;
}
