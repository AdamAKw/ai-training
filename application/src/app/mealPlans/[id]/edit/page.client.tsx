...
export default function EditMealPlanClient({ mealPlan, recipes }: EditMealPlanClientProps) {
   ...
   const handleSubmit = async (data: {
      ...
      try {
         ...
         if (!res.ok) {
            ...
            throw new Error(error.error || "Wystąpił problem podczas aktualizacji planu");
         }
   ...
   return (
      <div className="container py-10 max-w-5xl">
         ...
         <MealPlanForm initialData={mealPlan} recipes={recipes} onSubmit={handleSubmit} isSubmitting={isSubmitting} />
      </div>
   );
}
