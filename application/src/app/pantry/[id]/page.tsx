   ...
   return (
      <div className="container py-6">
         <div className="max-w-3xl mx-auto">
            <h1 className="text-3xl font-bold tracking-tight mb-4">{pantryItem.name}</h1>

            <div className="bg-card rounded-lg border p-6 shadow-sm">
               <dl className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                     <dt className="text-sm text-muted-foreground">Ilość</dt>
                  ...
                  {pantryItem.expiryDate && (
                     <div>
                        <dt className="text-sm text-muted-foreground">Data ważności</dt>
                        <dd className="text-lg font-medium">{formatDate(pantryItem.expiryDate)}</dd>
                     </div>
                  )}

                  <div>
                     <dt className="text-sm text-muted-foreground">Dodano</dt>
                     <dd className="text-lg font-medium">{formatDate(pantryItem.createdAt)}</dd>
                  </div>
               </dl>
            </div>
         </div>
