...
public class PantryResource {
    ...
    @POST
    public Uni<RestResponse<ApiResponse>> createPantryItem(
        @Valid @NotNull CreateItemRequest pantryItem) {
...
//        }
    ...
    /**
     * GET /api/pantry/expiring Get pantry items expiring within the specified number of days
     */
    @GET
    @Path("/expiring")
    public Uni<RestResponse<ApiResponse>> getExpiringItems(
